...
init_only() {
    ...
    log_success "TICK Stack 项目环境初始化完成！"
    echo ""
    echo "🚀 接下来的步骤："
    ...
    echo ""
    echo "🌐 服务端口："
    echo "- TICK Stack: http://localhost:8086"
    echo "- TICK Stack: http://localhost:8888"
    echo ""
}
