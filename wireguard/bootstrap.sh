...
init_only() {
    ...
    log_success "WireGuard 项目环境初始化完成！"
    echo ""
    echo "🚀 接下来的步骤："
    ...
    echo ""
    echo "🌐 服务端口："
    echo "- WireGuard: http://localhost:51820"
    echo ""
}
