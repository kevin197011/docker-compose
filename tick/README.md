# TICK Stack Docker Compose 部署

## 📖 项目简介

时间序列数据平台，包含 Telegraf、InfluxDB、Chronograf 和 Kapacitor
...
- **8086**: TICK Stack 服务端口
- **8888**: TICK Stack 服务端口
...
- TICK Stack: http://localhost:8086
- TICK Stack: http://localhost:8888
